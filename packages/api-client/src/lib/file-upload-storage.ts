import type { VERIFICATION_TYPES_BY_PRODUCT } from "../http/v2/verifications/verifications.types";
import { isR2UploadEnabled } from "@verifyafrica/ui/lib/cloudflare-r2";
import {
	deleteFileFromR2,
	uploadFileToR2,
