...
export const useWalletBalanceV2Query = (
	...
	return useQuery<Wallet>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.balance(tenantId ?? ""),
		),
		queryFn: () => {
			if (!tenantId) {
...
export const useAllWalletBalancesV2Query = (
	...
	return useQuery<PaginatedWalletBalanceListResult>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.allBalances(params),
		),
...
export const useTenantFundingRequestsV2Query = (
	...
	return useQuery<PaginatedWalletFundingRequestListResult>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.tenantFundingRequests(tenantId ?? "", params),
		),
		queryFn: () => {
			if (!tenantId) {
				throw new Error("Tenant ID is required");
...
export const useAllFundingRequestsV2Query = (
	...
	return useQuery<PaginatedWalletFundingRequestListResult>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.allFundingRequests(params),
		),
...
export const useTenantTransactionsV2Query = (
	...
	return useQuery<PaginatedWalletTransactionListResult>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.tenantTransactions(tenantId ?? "", params),
		),
		queryFn: () => {
			if (!tenantId) {
				throw new Error("Tenant ID is required");
...
export const useAllTransactionsV2Query = (
	...
	return useQuery<PaginatedWalletTransactionListResult>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.allTransactions(params),
		),
...
export const useTopUpVerifyV2Query = (
	...
	return useQuery<TopUpVerifyData>({
		queryKey: useOrganizationQueryKey(
			WALLET_V2_QUERY_KEYS.topUpVerify(tenantId ?? "", sessionId ?? ""),
		),
		queryFn: () => {
