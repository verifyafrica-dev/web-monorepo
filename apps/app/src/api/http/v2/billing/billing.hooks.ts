...
export const useTenantBillingInformationV2Query = (
	...
	return useQuery<BillingInformation>({
...
export const useAllBillingInformationV2Query = (
	...
	return useQuery<PaginatedBillingInformationListResult>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.allBillingInformation(params),
		),
...
export const useBillingPricingListV2Query = (
	...
	return useQuery<PaginatedBillingPricingListResult>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.billingPricingList(params),
		),
...
export const useBillingPricingDetailV2Query = (
	...
	return useQuery<BillingPricing>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.billingPricingDetail(id ?? ""),
		),
...
export const useTenantInvoicesV2Query = (
	...
	return useQuery<PaginatedTenantInvoiceListResult>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.tenantInvoices(tenantId ?? "", params),
		),
		queryFn: () => {
			if (!tenantId) {
				throw new Error("Tenant ID is required");
...
export const useTenantInvoiceDetailV2Query = (
	...
	return useQuery<Invoice>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.tenantInvoiceDetail(
				tenantId ?? "",
				invoiceId ?? "",
			),
		),
...
export const useAllInvoicesV2Query = (
	...
	return useQuery<PaginatedAllInvoiceListResult>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.allInvoicesList(params),
		),
...
export const useAllInvoiceDetailV2Query = (
	...
	return useQuery<Invoice>({
		queryKey: useOrganizationQueryKey(
			BILLING_V2_QUERY_KEYS.allInvoiceDetail(id ?? ""),
		),
