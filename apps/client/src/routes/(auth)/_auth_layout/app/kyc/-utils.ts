import type { KycStatus } from "@verifyafrica/api-client/http/v2/tenants/tenants.types";
import type { SectionRejectedReason } from "@verifyafrica/api-client/http/v2/tenants/tenants.types";
import type { KYBApplication } from "@verifyafrica/api-client/http/v2/kyc/kyc.types";
